...
- **CloudFront Distribution:** `[YOUR DISTRIBUTION ID HERE]`
- **CloudFront Origin Access Control:** `E1LBDJ5ESC7FYO`

### IAM Trust Policy (scoped to exact repo identity)
```json
{
  "Version": "2012-10-17",
  "Statement": [
    {
      "Effect": "Allow",
      "Principal": {
        "Federated": "arn:aws:iam::541673202339:oidc-provider/token.actions.githubusercontent.com"
      },
      "Action": ["sts:AssumeRoleWithWebIdentity", "sts:TagSession"],
      "Condition": {
        "StringEquals": {
          "token.actions.githubusercontent.com:aud": "sts.amazonaws.com",
          "token.actions.githubusercontent.com:sub": "repo:Ajokemi@125188622/github-actions-aws-s3-cicd@1347023967:ref:refs/heads/main"
        }
      }
    }
  ]
  ...
  "Statement": [
    {
      ...
      "Resource": "arn:aws:s3:::ajoketechhub-site-1787731351"
    },
    {
